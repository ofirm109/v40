    ...
    while (Shela == false) {
        ...
        if (thisgame[num - 1] != null) {
            ...
            if (thisgame[num - 1][1] == "true") {
                ...
                var vedo = '<iframe class="video imageOnePage" height="750px" width="100%" id="' + num + '" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>';
...
function End() {
    ...
    var fuulName = "היי " + myName + "<br/>" + "ריצנו לסכם בשבילך מה בחרת במשחק"
